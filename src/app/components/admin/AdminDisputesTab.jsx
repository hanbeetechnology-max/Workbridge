                ...
                {decision ? (
                  ...
                  <div className="flex gap-3 flex-wrap mt-4">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-semibold border border-blue-200 bg-blue-50 text-blue-700 hover:bg-blue-100 transition-colors disabled:opacity-60 dark:border-blue-900/40 dark:bg-blue-500/10 dark:text-blue-400 dark:hover:bg-blue-500/20"
                    >
                    ...
                    <button
                      ...
                      disabled={busyId === d.id}
                      className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-semibold border border-emerald-200 bg-emerald-50 text-emerald-700 hover:bg-emerald-100 transition-colors disabled:opacity-60 dark:border-emerald-900/40 dark:bg-emerald-500/10 dark:text-emerald-400 dark:hover:bg-emerald-500/20"
                    >
